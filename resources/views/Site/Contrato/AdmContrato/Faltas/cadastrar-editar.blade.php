<div class="row">
	<div class="col-lg-8 col-lg-offset-1 col-md-10 col-md-offset-1">
		@if ( isset($falta) )
		<form id="formCE" class="form" method="post" action="{{route('falta.update', $falta->id)}}">
			{!! method_field('PUT') !!} 
		@else
		<form id="formCE" method="POST" action="{{route('falta.store')}}">
		@endif 
		...
		<div class="form-horizontal form-label-left">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="motivo" 
					value="{{$falta->motivo or old('motivo')}}">
				</div>
			</div>
